...
4. Before handoff, integration, or PR readiness, compare the workstream with every active overlapping branch using `.venv/bin/observatory overlap <other-ref> --base-ref <base-ref>`.
