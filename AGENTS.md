...
1. Run `observatory validate`.
2. Run the complete repository test suite.
3. Run `observatory catalog` to a disposable output and confirm it succeeds.
4. Run `observatory preserve <base-ref>` against the intended PR base.
