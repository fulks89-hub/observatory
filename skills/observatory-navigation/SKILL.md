...
.venv/bin/observatory search "context engineering memory"

# Stable machine-readable result shape for agents/adapters
.venv/bin/observatory search --json --limit 8 "agent memory research recommendations"

# Deliberately inspect stale/superseded material
.venv/bin/observatory search --include-inactive "previous retrieval guidance"

# Reproducible freshness-aware recall; omit overdue material only when appropriate
.venv/bin/observatory search --as-of 2026-08-17 --exclude-stale "current agent memory guidance"

# Intentionally inspect historical/superseded knowledge within a project
.venv/bin/observatory search --include-noncurrent --project project-observatory "previous runtime decision"
```
