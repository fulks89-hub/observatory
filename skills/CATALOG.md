...
| Skill | Use when | Path |
| --- | --- | --- |
| Onboard Observatory | Fresh-clone local-only/private-GitHub setup, instruction-safe migration, owner workflow interview, or second-brain adoption | `skills/onboard-observatory/SKILL.md` |
